...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2017 at 05:53 PM
...
--
-- Table structure for table `hey_you_flag_here`
--

CREATE TABLE `hey_you_flag_here` (
  `flag` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

--
-- Dumping data for table `hey_you_flag_here`
--

INSERT INTO `hey_you_flag_here` (`flag`) VALUES
('s0_m4ny_w4y_t0_byp4ss');
